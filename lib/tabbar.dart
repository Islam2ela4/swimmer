...
class MainTabsState extends BaseScreen<MainTabs>
  ...
  Future<void> afterFirstLayout(BuildContext context) async {
    ...
    if (firebaseDynamicLinkConfig['isEnabled'] && isMobile) {
      ...
      var defaultParams = dynamicLinkService.defaultParameters();
      await dynamicLinkService.generateFirebaseDynamicLink(defaultParams);
  ...
  Widget tabView(Map<String, dynamic> data) {
    switch (data['layout']) {
      ...
      case 'cart':
        return CartScreen(showChat: data['showChat'] ?? false);
      case 'profile':
