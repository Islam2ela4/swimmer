...
class _ProductListLayoutState extends State<ProductListLayout> {
  ...
  Widget getProductListWidgets(context, List<Product> products, width) {
    ...
    var ratioProductImage = Provider.of<AppModel>(context, listen: false).ratioProductImage;
            ...
            builder:
              ...
              switch (snapshot.connectionState) {
                ...
                case ConnectionState.waiting:
                  return widget.config['layout'] == 'listTile' ? WaitingListItemTileWidget() : Column(
                          children: <Widget>[
                            HeaderView(
                                  ...
                                  children: [
                                    ...
                                    for (var i = 0; i < 4; i++)
                                      ProductCard(
                                        ...
                                        width: _buildProductWidth(constraint.maxWidth),
                    ...
                    return Column(
                      ...
                      children: <Widget>[
                        ...
                        HeaderView(
                          ...
                          showCountdown: (widget.config['showCountDown'] ??
                                  kSaleOffProduct['ShowCountDown'] ?? false) &&
                              isSaleOffLayout &&
                              _durationInMilliSeconds > 0,
                          countdownDuration:
                              Duration(milliseconds: _durationInMilliSeconds),
  ...
  int _getCountDownDuration(List<Product> data,
    ...
    if ((widget.config['showCountDown'] ?? kSaleOffProduct['ShowCountDown'] ?? false ) &&
        isSaleOffLayout &&
        data.isNotEmpty) {
