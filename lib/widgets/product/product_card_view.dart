...
class ProductCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    /// Sold by widget
    var _soldByStore = item.store != null && item.store.name != '' ? Padding(
            padding: const EdgeInsets.only(top: 2, bottom: 2),
            child: Text(S.of(context).soldBy + ' ' + item.store.name,
  ...
  void _onTapProduct(context) async{
    ...
    await customEvents("Page View", item.name); //here Page
  }
