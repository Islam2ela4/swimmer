...
class _ProductTitleState extends BaseScreen<ProductTitle> {
  ...
  Widget build(BuildContext context) {
    ...
    final dateOnSaleTo = DateTime.tryParse(productVariation?.dateOnSaleTo ?? widget.product.dateOnSaleTo ?? '')?.millisecondsSinceEpoch;
    final countDown = (dateOnSaleTo ?? 0) - DateTime.now().millisecondsSinceEpoch;
