...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  Future addNotificationChannel(String email) async {
    await Appgain()
        .addNotificationChannel({'notificationType': 'email', 'item': email});
  }


  Future setUserId(String id) async {
    await Appgain().setUserId({'userId': id});
  }
  ...
  Future<void> _submitRegister({
    ...
    var id =  await Provider.of<UserModel>(context, listen: false).createUser(
      ...
      if(id.isNotEmpty){
        await setUserId(id);
        await addNotificationChannel(emailAddress);
      }
